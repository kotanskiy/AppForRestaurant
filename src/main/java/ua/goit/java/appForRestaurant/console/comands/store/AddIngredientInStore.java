...
public class AddIngredientInStore implements Command{
    ...
    public void run() throws PropertyVetoException {
        ...
        storeDao.addIngredientInStore(Integer.parseInt(idIngredient), Integer.parseInt(count));
    }
}
