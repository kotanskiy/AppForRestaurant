package ua.goit.java.appForRestaurant.model.employee.jdbc;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.transaction.annotation.Transactional;
import ua.goit.java.appForRestaurant.model.employee.Employee;
import ua.goit.java.appForRestaurant.model.employee.EmployeeDao;
...
public class JdbcEmployeeDao implements EmployeeDao{
    ...
    public void add(Employee employee) {
        try(Connection connection = dataSource.getConnection();
            ...
            statement.setDate(4, java.sql.Date.valueOf(employee.getDataBirth()));
